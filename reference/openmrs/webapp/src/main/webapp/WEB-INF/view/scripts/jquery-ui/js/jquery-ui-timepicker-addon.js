   ...
   allowing multiple different settings on the same page. */
	...
	$.extend(Timepicker.prototype, {
	   ...
	   @return the manager object */
		...
		_parseTime: function (timeString, withDate) {
			var regstr =
					this._defaults.timeFormat
						...
						.replace(/t{1,2}/gi, this._getPatternAmpm())
		...
		_getPatternAmpm: function () {
			var markers = [];
			o = this._defaults;
			if (o.amNames) $.merge(markers, o.amNames);
			if (o.pmNames) $.merge(markers, o.pmNames);
		...
		_getFormatPositions: function () {
			var finds = this._defaults.timeFormat
					.toLowerCase()
		...
		_injectTimePicker: function () {
			var $dp = this.inst.dpDiv,
				...
				hourMax = (
					o.hourMax -
					((o.hourMax - o.hourMin) % o.stepHour)
				).toFixed(0),
				minMax = (
					o.minuteMax -
					((o.minuteMax - o.minuteMin) % o.stepMinute)
				).toFixed(0),
				secMax = (
					o.secondMax -
					((o.secondMax - o.secondMin) % o.stepSecond)
				).toFixed(0),
				millisecMax = (
					o.millisecMax -
					((o.millisecMax - o.millisecMin) % o.stepMillisec)
				).toFixed(0),
			...
			if (
				...
				if (o.showHour && o.hourGrid > 0) {
					...
					html +=
						'<dd class="ui_tpicker_hour" id="ui_tpicker_hour_' +
						dp_id +
						'"' +
						(o.showHour ? "" : noDisplay) +
						"></dd>";
				...
				if (o.showMinute && o.minuteGrid > 0) {
					...
					html +=
						'<dd class="ui_tpicker_minute" id="ui_tpicker_minute_' +
						dp_id +
						'"' +
						(o.showMinute ? "" : noDisplay) +
						"></dd>";
				...
				if (o.showSecond && o.secondGrid > 0) {
					html +=
						'<dd class="ui_tpicker_second ui_tpicker_second_' +
						o.secondGrid +
						'">' +
						'<div id="ui_tpicker_second_' +
						dp_id +
						'"' +
						(o.showSecond ? "" : noDisplay) +
						"></div>" +
					...
					html +=
						'<dd class="ui_tpicker_second" id="ui_tpicker_second_' +
						dp_id +
						'"' +
						(o.showSecond ? "" : noDisplay) +
						"></dd>";
				...
				if (o.showMillisec && o.millisecGrid > 0) {
					html +=
						'<dd class="ui_tpicker_millisec ui_tpicker_millisec_' +
						o.millisecGrid +
						'">' +
					...
					html +=
						'<dd class="ui_tpicker_millisec" id="ui_tpicker_millisec_' +
						dp_id +
						'"' +
						(o.showMillisec ? "" : noDisplay) +
						"></dd>";
				...
				if (o.showHour && o.hourGrid > 0) {
					size =
						(100 * hourGridSize * o.hourGrid) /
						(hourMax - o.hourMin);

					$tp.find(".ui_tpicker_hour table")
						.css({
							width: size + "%",
				...
				if (o.showMinute && o.minuteGrid > 0) {
					size =
						(100 * minuteGridSize * o.minuteGrid) /
						(minMax - o.minuteMin);
					$tp.find(".ui_tpicker_minute table")
						.css({
							width: size + "%",
				...
				if (o.showSecond && o.secondGrid > 0) {
					$tp.find(".ui_tpicker_second table")
						.css({
							width: size + "%",
				...
				if (o.showMillisec && o.millisecGrid > 0) {
					$tp.find(".ui_tpicker_millisec table")
						.css({
							width: size + "%",
				...
				function (match) {
					switch (match.toLowerCase()) {
						...
						case "tt":
							if (ampm) {
								var _ampm = time.ampm;
								if (match.length == 1) _ampm = _ampm.charAt(0);
	...
	$.datepicker._gotoToday = function (id) {
		...
		if (tp_inst._defaults.showTimezone && tp_inst.timezone_select) {
			...
			tzoffset =
				tzsign +
				("0" + (tzoffset - tzmin) / 60).slice(-2) +
				("0" + tzmin).slice(-2);
			if (tp_inst._defaults.timezoneIso8609)
				tzoffset =
					tzoffset.substring(0, 3) + ":" + tzoffset.substring(3);
	...
	//#######################################################################################
	$.datepicker._disableTimepickerDatepicker = function (
		target,
		date,
		withDate,
	) {
	...
	$.datepicker._enableTimepickerDatepicker = function (
		target,
		date,
		withDate,
	) {
	...
	$.datepicker._setTime = function (inst, date) {
		...
		if (tp_inst) {
			...
			if (
				...
				hour > defaults.hourMax ||
				minute < defaults.minuteMin ||
				minute > defaults.minuteMax ||
				second < defaults.secondMin ||
				second > defaults.secondMax ||
	...
	$.datepicker._formatDate = function (inst, day, month, year) {
		var tp_inst = this._get(inst, "timepicker");
		if (tp_inst) {
			if (day) var b = this._base_formatDate(inst, day, month, year);
