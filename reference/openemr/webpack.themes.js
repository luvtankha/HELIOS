...
module.exports = (env, argv) => {
  ...
  const themesConfig = {
    ...
    entry: {
      ...
      rtl_compact_style_light: entry(
        "oe-styles/style_light.scss",
        "rtl_compact",
      ),
      rtl_compact_style_dark: entry("oe-styles/style_dark.scss", "rtl_compact"),
      rtl_compact_style_solar: entry(
        "oe-styles/style_solar.scss",
        "rtl_compact",
      ),
      rtl_compact_style_manila: entry(
        "oe-styles/style_manila.scss",
        "rtl_compact",
      ),
      ...
      compact_style_cobalt_blue: entry(
        "colors/style_cobalt_blue.scss",
        "compact",
      ),
      compact_style_forest_green: entry(
        "colors/style_forest_green.scss",
        "compact",
      ),
      ...
      rtl_compact_style_cobalt_blue: entry(
        "colors/style_cobalt_blue.scss",
        "rtl_compact",
      ),
      rtl_compact_style_forest_green: entry(
        "colors/style_forest_green.scss",
        "rtl_compact",
      ),
      ...
      "misc/rtl_bootstrap_navbar": entry(
        "misc/bootstrap_navbar.scss",
        "rtl_misc",
      ),
