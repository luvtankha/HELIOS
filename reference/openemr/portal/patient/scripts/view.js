...
var view = {
  ...
  getPaginationHtml: function (page, top = false) {
    ...
    if (page.totalPages > 1) {
      ...
      if (first > 1) {
        html +=
          '<li><a class="pageButton btn btn-sm btn-outline-secondary" id="page-' +
          (first - 1) +
          '" href="#">&laquo;</a></li>';
      }
      for (let i = first; i <= last; i++) {
        html +=
          "<li" +
          (page.currentPage == i ? ' class="active"' : "") +
          ">" +
          '<a class="pageButton btn btn-sm btn-outline-secondary" id="page-' +
          i +
          '" href="#">' +
          i +
          "</a></li>";
  ...
  CollectionView: Backbone.View.extend({
    ...
    render: function () {
      ...
      if (typeof this.el == "undefined" && console)
        console.warn(
          "CollectionView.render element is not defined.  Collection may not render properly.",
        );
    ...
    handleCollectionSync: function (obj, resp, req) {
      ...
      if (obj instanceof Backbone.Collection) this.render();
    },
  ...
  ModelView: Backbone.View.extend({
    ...
    render: function () {
      ...
      if (typeof this.el == "undefined" && console)
        console.warn(
          "ModelView.render element is not defined.  Model may not render properly.",
        );
