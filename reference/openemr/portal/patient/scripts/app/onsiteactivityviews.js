...
const actpage = {
  ...
  init: function () {
    ...
    this.collectionView.on("rendered", function () {
      ...
      $("table.collection thead tr th").click(function (e) {
        ...
        actpage.fetchParams.orderDesc =
          prop == actpage.fetchParams.orderBy && !actpage.fetchParams.orderDesc
            ? "1"
            : "";
  ...
  showDetailDialog: function (m) {
    ...
    if (
      actpage.onsiteActivityView.id == null ||
      actpage.onsiteActivityView.id == ""
    ) {
