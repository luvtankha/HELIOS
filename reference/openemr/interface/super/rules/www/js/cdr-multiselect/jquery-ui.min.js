...
(function (b, d) {
  ...
  if (!b.ui.version) {
    ...
    b.each(["Width", "Height"], function (g, f) {
      ...
      var c = f === "Width" ? ["Left", "Right"] : ["Top", "Bottom"],
        h = f.toLowerCase(),
        i = {
    ...
    b.extend(b.ui, {
      ...
      contains: function (g, f) {
        return document.compareDocumentPosition
          ? g.compareDocumentPosition(f) & 16
          : g !== f && g.contains(f);
      },
...
(function (b, d) {
  ...
  b.widget.bridge = function (f, a) {
    b.fn[f] = function (c) {
      ...
      h
        ? this.each(function () {
            var n = b.data(this, f),
              q = n && b.isFunction(n[c]) ? n[c].apply(n, i) : n;
            if (q !== n && q !== d) {
              j = q;
              return false;
            }
  ...
  b.Widget.prototype = {
    ...
    _trigger: function (f, a, c) {
      ...
      a = b.Event(a);
      a.type = (
        f === this.widgetEventPrefix ? f : this.widgetEventPrefix + f
      ).toLowerCase();
      c = c || {};
      if (a.originalEvent) {
        ...
        var e = this,
          ...
          f =
            typeof this.options.cancel == "string"
              ? b(d.target).parents().add(d.target).filter(this.options.cancel)
                  .length
              : false;
    ...
    _generatePosition: function (d) {
      ...
      if (this.originalPosition) {
        ...
        if (e.grid) {
          c =
            this.originalPageY +
            Math.round((c - this.originalPageY) / e.grid[1]) * e.grid[1];
          c = this.containment
            ? !(
          ...
          a =
            this.originalPageX +
            Math.round((a - this.originalPageX) / e.grid[0]) * e.grid[0];
          a = this.containment
            ? !(
  ...
  b.ui.plugin.add("draggable", "scroll", {
    ...
    drag: function (d) {
      ...
      if (
        ...
        if (!g.axis || g.axis != "x")
          if (
            e.overflowOffset.top + e.scrollParent[0].offsetHeight - d.pageY <
            g.scrollSensitivity
          )
            e.scrollParent[0].scrollTop = f =
              e.scrollParent[0].scrollTop + g.scrollSpeed;
          else if (d.pageY - e.overflowOffset.top < g.scrollSensitivity)
            e.scrollParent[0].scrollTop = f =
              e.scrollParent[0].scrollTop - g.scrollSpeed;
        if (!g.axis || g.axis != "y")
          if (
            e.overflowOffset.left + e.scrollParent[0].offsetWidth - d.pageX <
            g.scrollSensitivity
          )
            e.scrollParent[0].scrollLeft = f =
              e.scrollParent[0].scrollLeft + g.scrollSpeed;
          else if (d.pageX - e.overflowOffset.left < g.scrollSensitivity)
            e.scrollParent[0].scrollLeft = f =
              e.scrollParent[0].scrollLeft - g.scrollSpeed;
      } else {
        if (!g.axis || g.axis != "x")
          if (d.pageY - b(document).scrollTop() < g.scrollSensitivity)
            ...
            b(window).height() - (d.pageY - b(document).scrollTop()) <
            g.scrollSensitivity
          )
            f = b(document).scrollTop(b(document).scrollTop() + g.scrollSpeed);
        if (!g.axis || g.axis != "y")
          if (d.pageX - b(document).scrollLeft() < g.scrollSensitivity)
            ...
            b(window).width() - (d.pageX - b(document).scrollLeft()) <
            g.scrollSensitivity
          )
            f = b(document).scrollLeft(
              b(document).scrollLeft() + g.scrollSpeed,
  ...
  b.ui.plugin.add("draggable", "snap", {
    ...
    drag: function (d, e) {
      for (
        ...
        if (
          (q - a < c && c < l + a && k - a < i && i < m + a) ||
          (q - a < c && c < l + a && k - a < j && j < m + a) ||
...
(function (b) {
  ...
  b.ui.intersect = function (d, e, g) {
    ...
    switch (g) {
      ...
      case "touch":
        return (
          ((c >= n && c <= q) || (h >= n && h <= q) || (c < n && h > q)) &&
          ((f >= i && f <= j) || (a >= i && a <= j) || (f < i && a > j))
        );
      default:
        return false;
    }
  ...
  b.ui.ddmanager = {
    ...
    prepareOffsets: function (d, e) {
      ...
      a: for (; c < g.length; c++)
        if (!(
          g[c].options.disabled ||
          (d && !g[c].accept.call(g[c].element[0], d.currentItem || d.element))
        )) {
...
(function (b) {
  b.widget("ui.resizable", b.ui.mouse, {
    ...
    _mouseCapture: function (g) {
      ...
      for (var a in this.handles)
        if (b(this.handles[a])[0] == g.target) f = true;
    ...
    _respectSize: function (g) {
      var f = this.options,
        a = this.axis,
        c = e(g.width) && f.maxWidth && f.maxWidth < g.width,
        h = e(g.height) && f.maxHeight && f.maxHeight < g.height,
        i = e(g.width) && f.minWidth && f.minWidth > g.width,
        j = e(g.height) && f.minHeight && f.minHeight > g.height;
    ...
    _proportionallyResize: function () {
      if (this._proportionallyResizeElements.length)
        for (
          var g = this.helper || this.element, f = 0;
    ...
    _change: {
      ...
      se: function (g, f, a) {
        return b.extend(
          ...
          this._change.e.apply(this, [g, f, a]),
        );
      },
      sw: function (g, f, a) {
        return b.extend(
          this._change.s.apply(this, arguments),
          this._change.w.apply(this, [g, f, a]),
        );
      },
      ne: function (g, f, a) {
        return b.extend(
  ...
  b.extend(b.ui.resizable, { version: "1.8.10" });
          ...
          b(n).each(function () {
            var l = b(this),
              ...
              o =
                q && q.length
                  ? q
                  : l.parents(f.originalElement[0]).length
                    ? ["width", "height"]
    ...
    stop: function () {
      ...
      if (g._revertToRelativePosition) {
        ...
        typeof f.alsoResize == "object" && !f.alsoResize.nodeType
          ? b.each(f.alsoResize, function (c) {
              a(c);
            })
          : a(f.alsoResize);
      }
  ...
  b.ui.plugin.add("resizable", "animate", {
    stop: function (g) {
      var f = b(this).data("resizable"),
        a = f.options,
        c = f._proportionallyResizeElements,
        h = c.length && /textarea/i.test(c[0].nodeName),
        i = h && b.ui.hasScroll(c[0], "left") ? 0 : f.sizeDiff.height;
      h = {
        width: f.size.width - (h ? 0 : f.sizeDiff.width),
        height: f.size.height - i,
      };
      i =
  ...
  b.ui.plugin.add("resizable", "containment", {
    start: function () {
      ...
      if (
        (f =
          a instanceof b ? a.get(0) : /parent/.test(a) ? f.parent().get(0) : a)
      ) {
    ...
    resize: function (g) {
      ...
      if (h.left < (f._helper ? c.left : 0)) {
        f.size.width += f._helper
          ? f.position.left - c.left
          : f.position.left - i.left;
      ...
      a = Math.abs(
        (f._helper ? f.offset.left - i.left : f.offset.left - i.left) +
          f.sizeDiff.width,
      );
      c = Math.abs(
        (f._helper ? f.offset.top - i.top : f.offset.top - c.top) +
          f.sizeDiff.height,
      );
    ...
    stop: function () {
      ...
      g._helper &&
        ...
        b(this).css({ left: j.left - c.left - a.left, width: n, height: i });
      g._helper &&
        !f.animate &&
  ...
  b.ui.plugin.add("resizable", "grid", {
    resize: function () {
      ...
      var j =
        Math.round((a.width - c.width) / (f.grid[0] || 1)) * (f.grid[0] || 1);
      f =
        Math.round((a.height - c.height) / (f.grid[1] || 1)) * (f.grid[1] || 1);
      if (/^(se|s|e)$/.test(i)) {
        ...
        b(d.target)
          ...
          .each(function () {
            ...
            if (f) {
              ...
              f.selecting = a;
              (f.selected = a)
                ? e._trigger("selecting", d, { selecting: f.element })
                : e._trigger("unselecting", d, { unselecting: f.element });
              return false;
            }
          });
...
(function (b) {
  b.widget("ui.sortable", b.ui.mouse, {
      ...
      for (e = this.items.length - 1; e >= 0; e--) {
        ...
        if (a)
          if (
            ...
            this.placeholder[a == 1 ? "next" : "prev"]()[0] != f &&
            !b.ui.contains(this.placeholder[0], f) &&
            (this.options.type == "semi-dynamic"
              ? !b.ui.contains(this.element[0], f)
              : true)
          ) {
    ...
    serialize: function (d) {
      ...
      d = d || {};
      b(e).each(function () {
        var f = (b(d.item || this).attr(d.attribute || "id") || "").match(
          d.expression || /(.+)[-=_](.+)/,
        );
        if (f)
          g.push(
    ...
    _intersectsWith: function (d) {
      var e = this.positionAbs.left,
        ...
        a = f + this.helperProportions.height,
        c = d.left,
        h = c + d.width,
        i = d.top,
        j = i + d.height,
      ...
      return this.options.tolerance == "pointer" ||
        ...
        : c < e + this.helperProportions.width / 2 &&
            ...
            i < f + this.helperProportions.height / 2 &&
    ...
    _createPlaceholder: function (d) {
      ...
      if (!g.placeholder || g.placeholder.constructor == String) {
        ...
        g.placeholder = {
          element: function () {
            var a = b(document.createElement(e.currentItem[0].nodeName))
              .addClass(
                f || e.currentItem[0].className + " ui-sortable-placeholder",
              )
      ...
      for (var e = null, g = null, f = this.containers.length - 1; f >= 0; f--)
        if (!b.ui.contains(this.currentItem[0], this.containers[f].element[0]))
          if (this._intersectsWith(this.containers[f].containerCache)) {
            if (!(
              e && b.ui.contains(this.containers[f].element[0], e.element[0])
            )) {
              e = this.containers[f];
              g = f;
            }
        ...
        if (this.containers.length === 1) {
          ...
          for (
            ...
            if (
              ...
              var h =
                this.items[c][this.containers[g].floating ? "left" : "top"];
              if (Math.abs(h - a) < e) {
                e = Math.abs(h - a);
                f = this.items[c];
              }
          ...
          if (f || this.options.dropOnEmpty) {
            ...
            f
              ? this._rearrange(d, f, null, true)
              : this._rearrange(d, null, this.containers[g].element, true);
            this._trigger("change", d, this._uiHash());
    ...
    _createHelper: function (d) {
      ...
      d.parents("body").length ||
        b(
          e.appendTo != "parent" ? e.appendTo : this.currentItem[0].parentNode,
        )[0].appendChild(d[0]);
    ...
    _clear: function (d, e) {
      ...
      if (!b.ui.contains(this.element[0], this.currentItem[0])) {
        ...
        for (f = this.containers.length - 1; f >= 0; f--)
          if (
            b.ui.contains(this.containers[f].element[0], this.currentItem[0]) &&
            !e
          ) {
            g.push(
              function (a) {
...
(function (b) {
  b.effects.bounce = function (d) {
    return this.queue(function () {
      var e = b(this),
        g = ["position", "top", "bottom", "left", "right"],
        f = b.effects.setMode(e, d.options.mode || "effect"),
      ...
      for (n = 0; n < h; n++) {
        ...
        q[j] = (a == "pos" ? "-=" : "+=") + c;
        l[j] = (a == "pos" ? "+=" : "-=") + c;
        e.animate(q, i / 2, d.options.easing).animate(
          l,
          i / 2,
          d.options.easing,
        );
  ...
  b.effects.explode = function (d) {
    return this.queue(function () {
      var e = d.options.pieces ? Math.round(Math.sqrt(d.options.pieces)) : 3,
        g = d.options.pieces ? Math.round(Math.sqrt(d.options.pieces)) : 3;
      d.options.mode =
      ...
      for (
        var c = f.outerWidth(true), h = f.outerHeight(true), i = 0;
        i < e;
        i++
      )
        for (var j = 0; j < g; j++)
...
(function (b) {
  b.effects.fold = function (d) {
    return this.queue(function () {
      ...
      var q = /([0-9]+)%/.exec(a);
      if (q) a = (parseInt(q[1], 10) / 100) * j[f == "hide" ? 0 : 1];
      if (f == "show")
...
(function (b) {
  b.effects.puff = function (d) {
    return this.queue(function () {
      var e = b(this),
        g = b.effects.setMode(e, d.options.mode || "hide"),
        f = parseInt(d.options.percent, 10) || 150,
        a = f / 100,
      ...
      b.extend(d.options, {
        ...
        from: g == "hide" ? c : { height: c.height * a, width: c.width * a },
      });
  ...
  b.effects.scale = function (d) {
    return this.queue(function () {
      var e = b(this),
        g = b.extend(true, {}, d.options),
        f = b.effects.setMode(e, d.options.mode || "effect"),
        a =
          parseInt(d.options.percent, 10) ||
          (parseInt(d.options.percent, 10) == 0 ? 0 : f == "hide" ? 0 : 100),
  ...
  b.effects.size = function (d) {
    return this.queue(function () {
      ...
      var m = {
        from: { y: e.from.height / k.height, x: e.from.width / k.width },
...
(function (b) {
  b.effects.shake = function (d) {
    return this.queue(function () {
      ...
      var f = d.options.direction || "left",
      ...
      e.show();
      b.effects.createWrapper(e);
      var i = f == "up" || f == "down" ? "top" : "left",
        j = f == "up" || f == "left" ? "pos" : "neg";
      f = {};
      var n = {},
        q = {};
      f[i] = (j == "pos" ? "-=" : "+=") + a;
      ...
      for (a = 1; a < c; a++)
        e.animate(n, h, d.options.easing).animate(q, h, d.options.easing);
  ...
  b.widget("ui.accordion", {
    ...
    _create: function () {
      ...
      d.headers
        ...
        .hide();
      d.active.length
        ? d.active.attr({ "aria-expanded": "true", tabIndex: 0 })
      ...
      if (!g.disabled)
        if (d.target) {
          ...
          if (!(this.running || (!g.collapsible && e))) {
            ...
            f.removeClass("ui-state-active ui-corner-top")
    ...
    _toggle: function (d, e, g, f, a) {
      ...
      e.prev().attr({ "aria-expanded": "false", tabIndex: -1 }).blur();
      d.prev().attr({ "aria-expanded": "true", tabIndex: 0 }).focus();
    },
              ...
              .animate(c, {
                step: function (i, j) {
                  ...
                  d.toShow[0].style[j.prop] =
                    f * a[j.prop].value + a[j.prop].unit;
                },
                duration: d.duration,
                easing: d.easing,
                complete: function () {
  ...
  b.widget("ui.autocomplete", {
    ...
    _create: function () {
      ...
      this.menu = b("<ul></ul>")
        ...
        .appendTo(b(this.options.appendTo || "body", g)[0])
    ...
    _setOption: function (e, g) {
      ...
      if (e === "appendTo")
        this.menu.element.appendTo(
          b(g || "body", this.element[0].ownerDocument)[0],
        );
    ...
    _normalize: function (e) {
      ...
      return b.map(e, function (g) {
        ...
        return b.extend(
          { label: g.label || g.value, value: g.value || g.label },
          g,
        );
      });
    },
    ...
    _renderItem: function (e, g) {
      return b("<li></li>")
        .data("item.autocomplete", g)
        .append(b("<a></a>").text(g.label))
        .appendTo(e);
    },
    _move: function (e, g) {
      if (this.menu.element.is(":visible"))
  ...
  b.widget("ui.menu", {
    ...
    activate: function (d, e) {
      ...
      if (this.hasScroll()) {
        ...
        else g >= a && this.element.attr("scrollTop", f + g - a + e.height());
      }
      this.active = e
        .eq(0)
        .children("a")
  ...
  var d,
    ...
    g = function (f) {
      ...
      if (a)
        h = c
          ? b(c).find("[name='" + a + "']")
          : b("[name='" + a + "']", f.ownerDocument).filter(function () {
              return !this.form;
            });
      return h;
    };
  b.widget("ui.button", {
    ...
    _resetButton: function () {
      if (this.type === "input")
        ...
        var f = this.buttonElement.removeClass(
        ...
        if (c.primary || c.secondary) {
          i.push(
            "ui-button-text-icon" +
              (h ? "s" : c.primary ? "-primary" : "-secondary"),
          );
          c.primary &&
            f.prepend(
...
(function (b, d) {
  ...
  b.extend(b.ui, { datepicker: { version: "1.8.10" } });
  ...
  b.extend(e.prototype, {
      ...
      if (!(
        ...
        if (!c.inline) {
          ...
          b.effects && b.effects[h]
            ? c.dpDiv.show(h, b.datepicker._get(c, "showOptions"), j, n)
    ...
    _checkOffset: function (a, c, h) {
      ...
      c.left -=
        h && c.left == a.input.offset().left ? b(document).scrollLeft() : 0;
      c.top -=
        h && c.top == a.input.offset().top + q ? b(document).scrollTop() : 0;
      c.left -= Math.min(
        c.left,
    ...
    _findPos: function (a) {
      for (
        ...
        a &&
        (a.type == "hidden" || a.nodeType != 1 || b.expr.filters.hidden(a));
      )
      ...
      if (!(!c || (a && c != b.data(a, "datepicker"))))
        if (this._datepickerShowing) {
          ...
          b.effects && b.effects[a]
            ? c.dpDiv.hide(a, b.datepicker._get(c, "showOptions"), h, i)
            : c.dpDiv[
                a == "slideDown"
                  ? "slideUp"
                  : a == "fadeIn"
        ...
        var j = (h ? h.dayNamesShort : null) || this._defaults.dayNamesShort,
          ...
          u = function (x, C, J) {
            ...
            for (C = 0; C < x.length; C++)
              if (
                c.substr(w, x[C].length).toLowerCase() == x[C].toLowerCase()
              ) {
                w += x[C].length;
                return C + 1;
              }
          ...
          if (o)
            ...
            switch (a.charAt(p)) {
              ...
              case "o":
                m += l(
                  "o",
                  (c.getTime() - new Date(c.getFullYear(), 0, 0).getTime()) /
                    864e5,
                  3,
                );
                break;
              ...
              case "y":
                m += q("y")
                  ? c.getFullYear()
                  : (c.getYear() % 100 < 10 ? "0" : "") + (c.getYear() % 100);
                break;
              case "@":
                m += c.getTime();
                break;
              ...
              : typeof c == "string"
                ...
                : typeof c == "number"
                  ? isNaN(c)
                    ? h
                    : i(c)
                  : new Date(c.getTime())) && c.toString() == "Invalid Date"
            ? h
            : c)
      ) {
        c.setHours(0);
    ...
    _isInRange: function (a, c) {
      ...
      a = this._getMinMaxDate(a, "max");
      return (
        (!h || c.getTime() >= h.getTime()) && (!a || c.getTime() <= a.getTime())
      );
    },
  ...
  b.widget("ui.dialog", {
    ...
    _create: function () {
      ...
      var f = this,
        a = f.options,
        c = a.title || "&#160;",
        h = b.ui.dialog.getTitleId(f.element),
        i = (f.uiDialog = b("<div></div>"))
          .appendTo(document.body)
          .hide()
          .addClass(
      ...
      f.element
        ...
        .appendTo(i);
      var j = (f.uiDialogTitlebar = b("<div></div>"))
          .addClass(
        ...
        n = b('<a href="#"></a>')
          ...
          .appendTo(j);
      (f.uiDialogTitlebarCloseText = b("<span></span>"))
      ...
      if (!this._isOpen) {
        ...
        b(
          f.element
            ...
            .get()
            .concat(
              c.find(".ui-dialog-buttonpane :tabbable").get().concat(c.get()),
            ),
        )
          .eq(0)
          .focus();
    ...
    _minHeight: function () {
      var f = this.options;
      return f.height === "auto"
        ? f.minHeight
        : Math.min(f.minHeight, f.height);
    },
    ...
    _setOptions: function (f) {
      ...
      this.uiDialog.is(":data(resizable)") &&
        this.uiDialog.resizable("option", c);
    },
    _setOption: function (f, a) {
      var c = this,
        h = c.uiDialog;
      switch (f) {
        ...
        case "closeText":
          ...
          break;
        case "dialogClass":
          h.removeClass(c.options.dialogClass).addClass(
    ...
    fit: {
      ...
      top: function (a, c) {
        ...
        h =
          ...
          h.scrollTop();
        a.top =
          h > 0 ? a.top - h : Math.max(a.top - c.collisionPosition.top, a.top);
      },
    },
    flip: {
      left: function (a, c) {
      ...
      top: function (a, c) {
        if (c.at[1] !== "center") {
          ...
          var i =
            ...
            n = -2 * c.offset[1];
          a.top +=
            c.collisionPosition.top < 0 ? i + j + n : h > 0 ? i + j + n : 0;
        }
      },
    },
  };
    ...
    _refreshValue: function () {
      ...
      if (this.options.values && this.options.values.length)
          ...
          if (g.options.range === true)
            if (g.orientation === "horizontal") {
              if (q === 0)
                g.range
                  .stop(1, 1)
                  [f ? "animate" : "css"]({ left: a + "%" }, e.animate);
              if (q === 1)
                g.range[f ? "animate" : "css"](
                  { width: a - h + "%" },
              ...
              if (q === 0)
                g.range
                  .stop(1, 1)
                  [f ? "animate" : "css"]({ bottom: a + "%" }, e.animate);
              if (q === 1)
                g.range[f ? "animate" : "css"](
                  { height: a - h + "%" },
                  { queue: false, duration: e.animate },
        ...
        if (d === "min" && this.orientation === "horizontal")
          this.range
            .stop(1, 1)
            [f ? "animate" : "css"]({ width: a + "%" }, e.animate);
        ...
        if (d === "min" && this.orientation === "vertical")
          this.range
            .stop(1, 1)
            [f ? "animate" : "css"]({ height: a + "%" }, e.animate);
...
(function (b, d) {
  ...
  b.widget("ui.tabs", {
    ...
    _tabId: function (c) {
      return (
        (c.title &&
          c.title.replace(/\s/g, "_").replace(/[^\w\u00c0-\uFFFF-]/g, "")) ||
    ...
    _tabify: function (c) {
      ...
      c = 0;
      for (var q; (q = this.lis[c]); c++)
        b(q)[
          b.inArray(c, j.disabled) != -1 && !b(q).hasClass("ui-tabs-selected")
            ? "addClass"
            : "removeClass"
        ]("ui-state-disabled");
    ...
    add: function (c, h, i) {
      ...
      q.length ||
        (q = b(n.panelTemplate).attr("id", c).data("destroy.tabs", true));
      q.addClass(
  ...
  b.extend(b.ui.tabs, { version: "1.8.10" });
