...
(function (oeFormatters) {
  ...
  function I18NDateFormat(date, displayFormatSetting = undefined) {
    ...
    let date_display_format =
      displayFormatSetting !== undefined
        ? displayFormatSetting
        : jsGlobals["date_display_format"];
  ...
  function TimeFormatRead(seconds = false) {
    ...
    const format =
      typeof date_display_format !== "undefined" ? date_display_format : 0;
