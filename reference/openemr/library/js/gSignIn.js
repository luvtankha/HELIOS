var GoogleSigin = {
  ...
  init: function (client_id, params = {}) {
    ...
    this.ele = Object.prototype.hasOwnProperty.call(params, "ele")
      ? $(params["ele"])
      : null;
    this.hide_element = Object.prototype.hasOwnProperty.call(
      params,
      "hide_element",
    )
      ? params["hide_element"]
      : this.hide_element;
    this.signin_btn = Object.prototype.hasOwnProperty.call(params, "signin_btn")
      ? params["signin_btn"]
      : this.signin_btn;
    this.error_container = Object.prototype.hasOwnProperty.call(
      params,
      "error_container",
    )
      ? params["error_container"]
    ...
    google.accounts.id.initialize({
      ...
      callback: (googleUser) => {
        this.onSignInSuccess(googleUser, this);
      },
    });
  ...
  renderButton: function () {
    google.accounts.id.renderButton(
      $(this.ele).find("#google-signin")[0],
      {
        ...
        onfailure: (error) => {
          this.onSignInFailure(error, this);
        },
  ...
  onSignInFailure: function (error, thisele) {
    if (thisele.error_container != "") {
      $(thisele.error_container).find("#form-error-container").remove();
      $(thisele.error_container).append(
        "<div id='form-error-container' class='error'>Please use google log in</div>",
      );
    }
  },
