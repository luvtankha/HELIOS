...
dwvOemr.gui.Toolbox = function (app) {
  ...
  this.setup = function (list) {
    // tool select
    var toolSelector = dwvOemr.html.createHtmlSelect(
      "toolSelect",
      list,
      "tool",
    );
...
dwvOemr.gui.WindowLevel = function (app) {
  ...
  this.setup = function () {
    ...
    // colour map select
    var cmSelector = dwvOemr.html.createHtmlSelect(
      "colourMapSelect",
      dwv.tool.colourMaps,
      "colourmap",
    );
  ...
  this.initialise = function () {
    ...
    var wlSelector = dwvOemr.html.createHtmlSelect(
      "presetSelect",
...
dwvOemr.gui.Draw = function (app) {
  ...
  this.setup = function (shapeList) {
    // shape select
    var shapeSelector = dwvOemr.html.createHtmlSelect(
      "shapeSelect",
      shapeList,
      "shape",
    );
    ...
    if (dwvOemr.browser.hasInputColor()) {
      ...
      colourSelector = dwvOemr.html.createHtmlSelect(
        "colourSelect",
        colours,
        "colour",
      );
