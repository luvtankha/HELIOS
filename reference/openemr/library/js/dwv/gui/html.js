 ...
 */
dwvOemr.html.appendRowForArray = function (
  table,
  input,
  level,
  maxLevel,
 ...
 * @param {String} rowHeader The content of the first cell of a row (mainly for objects).
 */
dwvOemr.html.appendRowForObject = function (
  table,
  input,
  level,
  maxLevel,
...
dwvOemr.html.appendRow = function (table, input, level, maxLevel, rowHeader) {
  ...
  if (input instanceof Array) {
    dwvOemr.html.appendRowForArray(
      table,
      input,
      level + 1,
      maxLevel,
  ...
  // object
    ...
    dwvOemr.html.appendRowForObject(
      table,
      input,
      level + 1,
      maxLevel,
      ...
      if (data_low.indexOf(term) >= 0) {
        ...
        while ((result = data_low.indexOf(term)) !== -1) {
          ...
          new_node.appendChild(
            dwvOemr.html.createHighlightNode(
 ...
 */
dwvOemr.html.translateTableColumn = function (
  table,
  columnNumber,
  i18nPrefix,
  i18nSuffix,
