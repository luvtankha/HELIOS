...
dwvOemr.browser.hasXmlHttpRequest = function () {
  return (
    dwvOemr.browser.askModernizr("xhrresponsetype") &&
...
dwvOemr.browser.hasTypedArray = function () {
  return (
    dwvOemr.browser.askModernizr("dataview") &&
    dwvOemr.browser.askModernizr("typedarrays")
  );
};
...
dwvOemr.browser._hasTypedArraySlice =
